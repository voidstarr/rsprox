package net.rsprox.protocol.v236.game.incoming.encoder.codec.buttons
...
public class IfButtonDEncoder : ProxyMessageEncoder<IfButtonD> {
    ...
    override fun encode(
        ...
        val buf = Unpooled.buffer().toJagByteBuf()
        // targetCombinedId: gCombinedIdAlt3
        ...
        // selectedCombinedId: gCombinedIdAlt1
...
public class IfButtonTEncoder : ProxyMessageEncoder<IfButtonT> {
    ...
    override fun encode(
        ...
        val buf = Unpooled.buffer().toJagByteBuf()
        // targetSub: g2
        buf.p2(message.targetSub)
        // selectedObj: g2Alt1
        buf.p2Alt1(message.selectedObj)
        // selectedSub: g2Alt2
        buf.p2Alt2(message.selectedSub)
        // selectedCombinedId: gCombinedIdAlt2
...
public class IfRunScriptEncoder : ProxyMessageEncoder<IfRunScript> {
    ...
    override fun encode(
        ...
        // combinedId: gCombinedIdAlt3 -> p4Alt3
        buf.p4Alt3(message.combinedId)
        // script: g4Alt2
        buf.p4Alt2(message.script)
        // sub: g2Alt2
