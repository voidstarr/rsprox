package net.rsprox.protocol.v236.game.incoming.encoder.codec.misc.user
...
public class IfCrmViewClickEncoder : ProxyMessageEncoder<IfCrmViewClick> {
    ...
    override fun encode(
        ...
        // behaviour3: g4Alt2
        buf.p4Alt2(message.behaviour3)
        // behaviour2: g4
        buf.p4(message.behaviour2)
        // behaviour1: g4Alt1
        buf.p4Alt1(message.behaviour1)
        // combinedId: gCombinedIdAlt2 -> p4Alt2
        buf.p4Alt2(message.combinedId)
        return buf.buffer
    }
}
...
public class MoveGameClickEncoder : ProxyMessageEncoder<MoveGameClick> {
    ...
    override fun encode(
        ...
        // x: g2
        buf.p2(message.x)
        // keyCombination: g1Alt3
        buf.p1Alt3(message.keyCombination)
        return buf.buffer
    }
}
...
public class TeleportEncoder : ProxyMessageEncoder<Teleport> {
    ...
    override fun encode(
        ...
        // z: g2Alt3
        buf.p2Alt3(message.z)
        // oculusSyncValue: g4Alt1
        buf.p4Alt1(message.oculusSyncValue)
        // x: g2
        buf.p2(message.x)
        return buf.buffer
    }
